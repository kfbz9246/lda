...
@author: root
'''
from numpy import zeros, full, multiply, sum, array, empty
from numpy.random import dirichlet, multinomial
from os import getpid, mkdir, rmdir
from os.path import abspath, join
from cPickle import dump

def lda_posterior(data, number_components, sample_dir_path, number_samples, sample_output_size=100, alpha=1, beta=1,):
    ...
    for sample_number in range(number_samples):
        ...
        component_distrobution_samples[:,:,samples_in_subset_counter] = component_distrobution_sample
        ...
        subunit_distrobution_samples[:,:,samples_in_subset_counter] = subunit_distrobution_sample
